...
void applySoilSimulation(const Core::Domain::Soils::ScorpanParams& params, int visualizationLevel) { 
    if (g_Engine) g_Engine->applySoilSimulation(params, visualizationLevel); 
}
