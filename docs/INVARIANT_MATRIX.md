...
2. Scenario-level enforcement now includes observational-to-infrastructure coupling protection; additional cross-context scenario families are still pending (for example cognitive-assistance side-effect constraints).
