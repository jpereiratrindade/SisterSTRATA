...
3. Determinism enforcement is currently Tier-1 (same binary/config/seed); cross-runner and cross-compiler determinism guarantees are outside current scope.
