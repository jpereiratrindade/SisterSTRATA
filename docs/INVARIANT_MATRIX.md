...
3. Determinism enforcement is currently Tier-1 (same binary/config/seed); cross-runner replay telemetry is available in CI (`f2-determinism-replay`), but mismatch is currently reported as warning (non-blocking).
