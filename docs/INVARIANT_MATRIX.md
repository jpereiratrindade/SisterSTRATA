...
2. Scenario-level enforcement now includes observational/cognitive/impact-profile/persistence-to-infrastructure coupling protection; additional cross-context scenario families are still pending (for example world-loading sidecar path constraints under mixed datasets).
