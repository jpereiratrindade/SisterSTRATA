...
2. Scenario-level enforcement now includes observational/cognitive/impact-profile/persistence/world-loading-to-infrastructure coupling protection; additional cross-context scenario families are still pending (for example malicious world-sidecar payload injection constraints).
