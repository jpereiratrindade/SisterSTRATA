...
- [Release Notes v1.10.7](releases/v1.10.7.md)
- [Release Notes v1.10.6](releases/v1.10.6.md)
...
## Infraestrutura e resiliencia
- [Implementacao Infrastructure Resilience v0.1](INFRASTRUCTURE_RESILIENCE_IMPLEMENTATION_v0_1.md)
- [DDD InfrastructureLayer v0.1](../STRATA_DDD_InfrastructureLayer_v0_1.md)
...
- [STRATA Governance Model v0.1](../STRATA_Governance_Model_v0_1.md)
...
- [ADR-007 Canonical Versioning Contract (engine + scientific model)](../adr/ADR-007_Canonical_Versioning_Contract_for_Engine_and_Scientific_Model.md)
...
- [Release Stability Criteria](RELEASE_STABILITY_CRITERIA.md)
- [Scientific Model Version (JSON canonico)](SCIENTIFIC_MODEL_VERSION.json)
